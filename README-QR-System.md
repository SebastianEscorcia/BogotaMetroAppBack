...
Sistema de generación y validación de códigos QR para control de acceso, implementado con Spring Boot, MySQL y Redis.
...
-  Caché en Redis para respuestas ultra-rápidas
...
├── externalservices/
│   └── RedisCacheService.java       # Servicio de caché Redis
├── mapper/qr/
...
│   └── repository/qr/
│       ├── QrRepository.java        # Repositorio QR
...
│   ├── QrServiceImpl.java           # Implementación
...
| Key Pattern | Descripción | TTL |
|-------------|-------------|-----|
| `usuario:{id}:qr` | QR activo por usuario | Tiempo restante hasta expiración |
| `qr:{codigo}` | QR por código | Tiempo restante hasta expiración |
...
Este proyecto es parte del sistema BogotaMetroApp - SENA 2025 - SebastianEscorcia - Jeniffer Saumeth - 
